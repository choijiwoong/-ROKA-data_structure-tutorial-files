...
int main(){
	...
	Person* sp;
	Person* rp;
	TBLInit(&myTbl, MyHashFunc);//initialziation & register hashfunc
	
	
	np=MakePersonData(990254, "Lee", "seoul");//insert data
	...
	sp=TBLSearch(&myTbl, 990254);//search data
	if(sp!=NULL)
		ShowPerInfo(sp);
